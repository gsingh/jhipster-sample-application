...
import com.platemill.myapp.domain.JobHistory;
import com.platemill.myapp.repository.JobHistoryRepository;
import com.platemill.myapp.repository.search.JobHistorySearchRepository;
import com.platemill.myapp.service.JobHistoryService;
...
import com.platemill.myapp.domain.enumeration.Language;
/**
...
public class JobHistoryResourceIT {
     ...
     *
     * @see com.platemill.myapp.repository.search.JobHistorySearchRepositoryMockConfiguration
     */
    @Autowired
